...
async function main() {
  ...
  dateBase.setDate(dateBase.getDate() + ((6 - dateBase.getDay() + 7) % 7)); // Next Saturday
  dateBase.setHours(10, 0, 0, 0);

  const sat1 = new Date(dateBase);
  const sat2 = new Date(dateBase); sat2.setDate(sat2.getDate() + 7);
  const sat3 = new Date(dateBase); sat3.setDate(sat3.getDate() + 14);
  const sat4 = new Date(dateBase); sat4.setDate(sat4.getDate() + 21);
  ...
  await prisma.liveSession.createMany({
    data: [
      { title: "Week 1: Vibe Coding Foundations - Practical Session", description: "Welcome, programme overview, live demo of Claude and Cursor, and hands-on setup.", date: sat1, duration: "2 Hours 30 Minutes", instructor: "Church Technology Class", link: "In-Person", secretCode: "112233", courseId: vibeCourseId! },
      { title: "Week 2: Vibe Coding In Practice - Build Session", description: "Live prompt engineering exercises and publishing a web project.", date: sat2, duration: "2 Hours 30 Minutes", instructor: "Church Technology Class", link: "In-Person", secretCode: "445566", courseId: vibeCourseId! },
    ]
  });
  ...
  await prisma.liveSession.createMany({
    data: [
      { title: "Week 3: AI Automation Foundations", description: "Introduction to AI Automation, Zapier walkthrough, and hands-on build.", date: sat3, duration: "2 Hours 30 Minutes", instructor: "Mr Johnwell", link: "In-Person", secretCode: "778899", courseId: autoCourseId! },
      { title: "Week 4: Advanced Automation and Graduation", description: "Advanced workflows, final showcase, and graduation ceremony.", date: sat4, duration: "3 Hours", instructor: "Mr Johnwell", link: "In-Person", secretCode: "990011", courseId: autoCourseId! },
    ]
  });
